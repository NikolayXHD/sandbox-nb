...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$eCaK+ZlsGNmv7dimUaXgUg$hUrSw4tdZLiJrowI4tzKsXOTtoqdRLtnhYVmXJV/WXU'
...
#  Choices: any of ['blake2b', 'sha3_384', 'sha256', 'blake2s', 'sha3_256', 'sha1', 'sha3_224', 'sha224', 'md5', 'sha512', 'sha384', 'sha3_512']
#  Default: 'sha256'
